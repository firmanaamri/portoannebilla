...
export default function Contact() {
  ...
  return (
    <section id="contact" style={{ background: "rgba(0,0,0,0.15)", position: "relative", overflow: "hidden" }}>
        ...
        >
          ...
          >
            <motion.div 
              ...
              style={{
                padding: "2.5rem",
                background: "linear-gradient(135deg, rgba(201,169,110,0.08), rgba(224,122,159,0.05))",
          ...
          >
            {contacts.map((c) => (
              <motion.a
                ...
                whileHover={{ x: 8, backgroundColor: "rgba(201,169,110,0.06)", borderColor: "var(--accent-primary)" }}
